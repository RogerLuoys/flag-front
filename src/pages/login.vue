  ...
  <div>
    <div style="display: flex;justify-content: center;margin-top: 90px">
      <el-card style="width: 400px;">
        ...
        <div>
          <el-row>
            <el-input v-model="user.username" placeholder="请输入账号或手机号"></el-input>
          </el-row>
          <el-row>
            <el-input v-model="user.password" type="password" placeholder="请输入密码" @keydown.enter.native="doLogin"></el-input>
          </el-row>
          <el-row>
